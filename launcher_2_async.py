...
def main(_):
    ...
    with xm_local.create_experiment(experiment_title='pipeline_async') as experiment:
        ...
        @parameter_controller.controller(
            ...
            controller_args={
                'db_config': xmngr_db_uri,
                'controller_id': 'main_tuning_controller'
            },
            controller_env_vars={
                # Pass any DB credentials the controller might need as env vars
                'POSTGRES_USER': env_config.get('POSTGRES_USER'),
                'POSTGRES_PASSWORD': env_config.get('POSTGRES_PASSWORD'),
            }
        )
        
        async def training_pipeline(experiment: xm.Experiment):
        ...
        experiment.add(training_pipeline())
