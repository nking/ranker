...
│   ├── xmanager/   
│   │   └── launcher.py             # XManager script (xm_local + docker socket)   
│   
├── scripts/                        # Operational Bash/Utility Scripts   
...
The code was developed and run on amd64 architecture.  
...
(5) there are a couple of ways to start the services depending on what
    ...
    (a) to run test_Ranker.py or the xmanager pipeline 
...
- cd orchestration/k8s 
  ...
  or 
  python3 run_app_trainer_kfp.sh  
